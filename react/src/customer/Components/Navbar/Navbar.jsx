        ...
        <div className="mx-auto px-4">
          <div className="flex justify-between items-center">
            ...
            <Link to="/" className="flex items-center py-6">
              <img
                src="https://cvillebiohub-media.s3.amazonaws.com/content/uploads/2023/05/12115949/AgroSpheres_logo_412x310-412-%C3%97-310-px.png"
                alt="Shopwithagrosphere"
                className="h-8 w-8 mr-2"
              />
              <span className="font-bold text-white text-lg">
                Shop With Agro Sphere
              </span>
            </Link>
